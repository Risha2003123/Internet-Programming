...
<style>
    ...
    .login-box h1 {
        color: #916f6f; /* Dark nude color for the login header */
        font-size: 24px;
        margin-bottom: 20px;
    }
    ...
    .button {
        ...
        background-color: #916f6f; /* Dark nude color for the button */
        border: none;
        border-radius: 5px;
        font-size: 18px;
        cursor: pointer;
    ...
    .textbox button {
        background: none;
        border: none;
        color: #916f6f; /* Dark nude color for the button text */
        cursor: pointer;
        font-size: 16px;
    ...
    .signup-link a {
        color: black; /* Dark nude color for the signup link */
        text-decoration: underline;
    }
</style>
...
<body>
    ...
    <form action="validate.php" method="post">
        <div class="login-box">
            ...
            <div class="textbox">
                <button type="button" onclick="location.href='adminlogin.php'">Admin Login</button>
                <button type="button" onclick="location.href='directorlogin.php'">Director Login</button>
            </div>
        </div>
    </form>
